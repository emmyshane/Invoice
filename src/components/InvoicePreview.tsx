  ...
  ({ invoiceData }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* Ship To Information */}
        {(invoiceData.shippingName || invoiceData.shippingAddress || invoiceData.shippingPhone || invoiceData.shippingEmail) && (
          <div className="mb-8 pb-6 border-b border-gray-200">
            <div className="grid grid-cols-2 gap-12">
              <div></div> {/* Empty column to align with Bill To section */}
              <div>
                <h3 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-wide">
                  Ship To
                </h3>
                <div className="text-sm text-gray-700 space-y-1">
                  {invoiceData.shippingName && (
                    <p className="font-semibold text-gray-900">{invoiceData.shippingName}</p>
                  )}
                  {invoiceData.shippingAddress && (
                    <div className="whitespace-pre-line">{invoiceData.shippingAddress}</div>
                  )}
                  {invoiceData.shippingPhone && <p>{invoiceData.shippingPhone}</p>}
                  {invoiceData.shippingEmail && <p>{invoiceData.shippingEmail}</p>}
                </div>
              </div>
            </div>
          </div>
